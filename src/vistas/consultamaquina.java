...
public class consultamaquina extends javax.swing.JInternalFrame {

  
    public consultamaquina() {
        initComponents();
      ...
      public void mostrartabla() {
          ...
          try {
            if (conexion.getConexion() != null) {
                ...
                ArrayList<Object[]> lista = consulta.consultamaquina(TXTCODIGO.getText());
 ...
 System.out.println(e.getMessage());
    ...
    private void initComponents() {
        ...
        getContentPane().add(TXTCODIGO, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 10, 220, 40));
